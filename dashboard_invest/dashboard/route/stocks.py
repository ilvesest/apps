...
from dashboard.logic.io import ioCacheAndLog, read_gsheet, getDFs, findRefRowCol, comment_button
...
def stocksScript(df:pd.DataFrame) -> dict:
    ...
    df_dict_stocks = getDFs(df, references_dict)
    ...
    result_dict['df_stocks_info'] = df_stocks_info
    
    df_stocks = df_stocks.loc[~df_stocks.index.isin(all_nan_idx),] # df stocks
    result_dict['df_stocks'] = df_stocks
    ...
    result_dict['stocks_ana_title'] = stocks_ana_title
    ...
    result_dict['df_stocks_ana'] = df_stocks_ana

    ### SUGGESTED SECTORS
    stock_sectors_title = "Suggested sectors for long term value"
    result_dict['stock_sectors_title'] = stock_sectors_title
    ...
    result_dict['df_sectors'] = df_sectors    
    ...
    result_dict['stocks_plot_js'] = stocks_plot_js
    result_dict['stocks_plot_div'] = stocks_plot_div
